...
const Icons = {
  ...
  settings: (<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10 1.75c.82 0 1.52.58 1.68 1.39l.22 1.09c.09.46.58.73 1.02.56l1.04-.4c.76-.29 1.63.02 2.05.72.41.7.27 1.6-.35 2.13l-.85.72c-.36.3-.36.86 0 1.16l.85.72c.62.53.76 1.43.35 2.13-.42.7-1.29 1.01-2.05.72l-1.04-.4c-.44-.17-.93.1-1.02.56l-.22 1.09A1.72 1.72 0 0110 18.25c-.82 0-1.52-.58-1.68-1.39l-.22-1.09a.78.78 0 00-1.02-.56l-1.04.4a1.72 1.72 0 01-2.05-.72 1.72 1.72 0 01.35-2.13l.85-.72c.36-.3.36-.86 0-1.16l-.85-.72A1.72 1.72 0 013.99 5.1c.42-.7 1.29-1.01 2.05-.72l1.04.4c.44.17.93-.1 1.02-.56l.22-1.09A1.72 1.72 0 0110 1.75z" /><circle cx="10" cy="10" r="2.5" /></svg>),
  ...
  gearSmall: (<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 1.4c.65 0 1.22.46 1.34 1.11l.18.87c.07.37.46.58.82.45l.83-.32c.61-.23 1.3.01 1.64.57.33.56.21 1.28-.28 1.7l-.68.58a.63.63 0 000 .92l.68.58c.49.42.61 1.14.28 1.7-.34.56-1.03.8-1.64.57l-.83-.32a.63.63 0 00-.82.45l-.18.87A1.38 1.38 0 018 14.6c-.65 0-1.22-.46-1.34-1.11l-.18-.87a.63.63 0 00-.82-.45l-.83.32c-.61.23-1.3-.01-1.64-.57-.33-.56-.21-1.28.28-1.7l.68-.58a.63.63 0 000-.92l-.68-.58a1.38 1.38 0 01-.28-1.7c.34-.56 1.03-.8 1.64-.57l.83.32c.36.13.75-.08.82-.45l.18-.87A1.38 1.38 0 018 1.4z" /><circle cx="8" cy="8" r="2" /></svg>),
